...
return(
 ...
 <a href="">
  ...
  >
    <g>
      <path
        d="M32,14c-9.925,0-18,8.075-18,18s8.075,18,18,18s18-8.075,18-18S41.925,14,32,14z M32,46c-7.72,0-14-6.28-14-14
      ...
      <path
        d="M50.586,10.586l-4,4c-0.781,0.781-0.781,2.047,0,2.828C46.976,17.805,47.488,18,48,18s1.024-0.195,1.414-0.586l4-4
		c0.781-0.781,0.781-2.047,0-2.828C52.634,9.805,51.366,9.805,50.586,10.586z"
      />
      <path
        d="M14.586,46.586l-4,4c-0.781,0.781-0.781,2.047,0,2.828C10.976,53.805,11.488,54,12,54s1.024-0.195,1.414-0.586l4-4
		c0.781-0.781,0.781-2.047,0-2.828C16.634,45.805,15.366,45.805,14.586,46.586z"
      />
      <path
        d="M49.414,46.586c-0.78-0.781-2.048-0.781-2.828,0c-0.781,0.781-0.781,2.047,0,2.828l4,4C50.976,53.805,51.488,54,52,54
		s1.024-0.195,1.414-0.586c0.781-0.781,0.781-2.047,0-2.828L49.414,46.586z"
      />
      <path
        d="M10.586,10.586c-0.781,0.781-0.781,2.047,0,2.828l4,4C14.976,17.805,15.488,18,16,18s1.024-0.195,1.414-0.586
  ...
  <p>Darko's Wather App</p>
        ...
        <div className="date">11.03.2024</div>
